...
python workspace_tools/build.py -t GCC_ARM -m NUCLEO_L476RG
...
Compile heap_check:
===================
python workspace_tools/make.py -t GCC_ARM -m NUCLEO_L476RG -d /media/betzw/NODE_L476RG -n betzw_test_4
